import pubImage from "../assets/pubfront.jpg"; // Replace with path to your pub's image
      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="border-4 border-[#BB945C] bg-white p-6 ">
            ...
            }} className="text-3xl md:text-5xl font-bold text-gray-800 mb-4 ">About Us</h2>
            ...
            <p className="text-gray-600 mb-4">
              ...
              our food. Whether you're a beer enthusiast, a wine connoisseur, or
              a lover of spirits, our offerings cater to all tastes.
            </p>
            <p className="text-gray-600 mb-4">
              Our large beer garden is a haven for those sunny days when all you
              want to do is bask in the coastal atmosphere. It's the perfect
              setting to unwind, enjoy a refreshing drink, and soak up the sun.
            </p>
            <p className="text-gray-600">
              At The Queen's Head, we're more than just a pub. We're a place
              where food, drinks, and the sea come together to create
              unforgettable experiences. Join us for a meal and let us transport
              you to a world of coastal charm and culinary delight.
            </p>
          </div>
        </div>
      </div>
