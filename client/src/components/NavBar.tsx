  ...
  return (
    <>
      ...
      >
        ...
        <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-black border-2 border-[#BB945C] overflow-y-auto">
          <div className="flex items-center mb-8">
            ...
            <button className="navbar-close" onClick={toggleMenu}>
              <svg
                className="h-6 w-6 text-[#FFFAE2] cursor-pointer hover:text-[#BB945C]"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
          ...
          <div>
            <div className="flex  justify-center items-center">
              <img
                ...
                className="w-32 md:w-64 mb-4" // This sets the width to 128px on small screens and 256px on medium screens and up
              />
            </div>
            <ul className="py-8">
              <li className="mb-1">
          ...
          <div className="mt-auto">
            <div className="pt-6">
              <div className="flex space-x-4 justify-center items-center">
                <img src={sports} alt="" className="w-40" />
              </div>
            </div>
